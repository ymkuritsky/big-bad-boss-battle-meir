(() => {
  ...
  const CHARACTERS = {
    ...
    kingDock: {
      ...
      powers: [
        ...
        { id: "ghostBats", name: "Ghost Bats", icon: "bat" },
  ...
  function summonGhostBats(fighter) {
    ...
    setBubble(fighter, "Ghost bats!", true, 1100);
    showComicText("GHOST BATS!", fighter.x, fighter.y - fighter.z - 142, fighter.character.accent);
    playEffect("mouth");
  }
